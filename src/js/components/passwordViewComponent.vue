<template>
  <span>
    ...
    <a v-if="'******'==viewContent" @click.prevent="viewPlainText(true)">
    ...
    <a v-else @click.prevent="viewPlainText(false)">
    ...
    <a href="javascript:;" @click="doCopy">
...
const viewPlainText = (plain) =>{
  if (true === plain) {
    viewContent.value = props.dataContent;
  } else {
    viewContent.value = '******';
  }
...
const  doCopy = () => {
  proxy.$copyText(props.dataContent).then(function (e) {
